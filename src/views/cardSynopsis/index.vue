    ...
    <div class="app-container">
      <div class="conetntBox">
        ...
        <el-table :data="dataList" max-height="600" v-loading="loading">
          ...
          <el-table-column label="简介内容" align="center" prop="content" :show-overflow-tooltip="true" />
            ...
            <el-row>
              ...
              <el-col :span="24">
                <el-form-item label="简介标题" prop="title">
                  <el-input v-model="formData.title" placeholder="请输入简介标题" />
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <!-- <el-form-item label="简介内容" prop="content">
                  <el-input type="textarea" :rows="4" v-model="formData.content" placeholder="请输入简介内容" />
                </el-form-item> -->
                 <el-row>
                  <editor v-model="formData.content":min-height="340"/>
                </el-row>
              </el-col>
            </el-row>
          </el-form>
...
import { cardSynopsisList, cardSynopsisAdd, cardSynopsisDelete,cardSynopsisUpdate} from "@/api/card/cardSynopsis";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      cardSynopsisList(this.queryParams).then(res => {
      ...
      this.$refs["formData"].validate(valid => {
        if (valid) {
          if(this.formData.id){//编辑
             cardSynopsisUpdate(this.formData).then(res => {
              if(res.code == 200){
            ...
            cardSynopsisAdd(this.formData).then(res => {
              if(res.code == 200){
    ...
    handleDelete(row) {
      this.$modal.confirm('是否确认删除？').then(function () {
        return cardSynopsisDelete(row.id);
      }).then(() => {
        this.getList();
