      ...
      <div class="conetntBox">
        ...
        <el-table :data="dataList" max-height="600" v-loading="loading">
          <el-table-column label="序号" type="index" width="50" align="center" />
           <el-table-column label="接收人邮箱" align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.userData">
                {{ scope.row.userData.userEmail }}
              </span>
            </template>
          </el-table-column>
          <el-table-column label="接收人手机号" align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.userData">
                {{ scope.row.userData.mobileNumber }}
              </span>
            </template>
          </el-table-column>
