    ...
    <div class="app-container">
      <div class="conetntBox">
        ...
        <el-table :data="dataList" max-height="600" v-loading="loading">
          ...
          <el-table-column label="访问地址" align="center" prop="configUrl" :show-overflow-tooltip="true"/>
        ...
        <el-dialog :title="title" :visible.sync="dialogOpen" width="60%" :close-on-click-modal="false" append-to-body>
          <el-form ref="formData" :model="formData" :rules="rules" label-width="100px">
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="协议类型" prop="configType">
                  <el-select v-model="formData.configType" filterable placeholder="请选择协议类型" :disabled="upState"  style="width: 100%;">
                    <el-option v-for="item in protocolTypeList" :key="item.id" :label="item.name" :value="item.id">
                    </el-option>
                  </el-select>
                </el-form-item>
...
<script>
import { getLanguage,findProtocolTypeList} from "@/api/dic/dic";
