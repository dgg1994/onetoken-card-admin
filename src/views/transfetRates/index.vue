    ...
    <div class="app-container">
      <div class="conetntBox">
        ...
        <el-table :data="dataList" max-height="600" v-loading="loading">
          ...
          <el-table-column label="转账费率" align="center" prop="rates" />
        ...
        <el-dialog :title="title" :visible.sync="dialogOpen" width="30%" :close-on-click-modal="false" @close="handleClose" append-to-body>
          <el-form ref="formData" :model="formData" :rules="rules" label-width="100px">
            <el-row>
              <el-col :span="24">
                <el-form-item label="转账费率" prop="rates">
                  <el-input type="number" v-model="formData.rates" placeholder="请输入转账费率" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
...
import { walletTransfetRatesList, walletTransfetRatesAdd, walletTransfetRateUpdate} from "@/api/walletTransfetRates/walletTransfetRates";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      walletTransfetRatesList(this.queryParams).then(res => {
      ...
      this.$refs["formData"].validate(valid => {
        if (valid) {
          ...
          if(this.formData.id){//编辑
             walletTransfetRateUpdate(this.formData).then(res => {
              if(res.code == 200){
