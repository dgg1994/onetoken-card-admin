      ...
      <div class="conetntBox">
        <div class="flex_sb">
          <el-form :model="queryParams" size="small" :inline="true" label-width="68px">
            ...
            <el-form-item label="" prop="articleName">
              <el-input v-model="queryParams.articleName" placeholder="请输入标题" clearable style="width: 240px"
        ...
        <el-table :data="dataList" max-height="600" v-loading="loading">
          ...
          <el-table-column label="文章内容" align="center" prop="articleContent" :show-overflow-tooltip="true" />
            ...
            <el-row>
              ...
              <el-col :span="24">
                <el-form-item label="文章标题" prop="articleName">
                  <el-input v-model="formData.articleName" placeholder="文章标题" />
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <!-- <el-form-item label="简介内容" prop="content">
                 ...
                 <el-row>
                  <editor v-model="formData.articleContent":min-height="340"/>
                </el-row>
              </el-col>
            </el-row>
          </el-form>
...
import { addHelp, updateHelp, findHelp,deleteHelp} from "@/api/help/help";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      findHelp(this.queryParams).then(res => {
      ...
      this.$refs["formData"].validate(valid => {
        if (valid) {
          if(this.formData.id){//编辑
             updateHelp(this.formData).then(res => {
              if(res.code == 200){
