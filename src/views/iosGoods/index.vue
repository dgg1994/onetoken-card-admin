    ...
    <div class="app-container">
      <div class="conetntBox">
        <div class="flex_sb">
          <el-form :model="queryParams" size="small" :inline="true" label-width="68px">
            <el-form-item label="" prop="goodsName">
              <el-input v-model="queryParams.goodsName" placeholder="请输入商品名称" />
            </el-form-item>
             <el-form-item label="" prop="goodsNum">
              <el-input v-model="queryParams.goodsNum" placeholder="请输入商品编号" />
            </el-form-item>
            <el-form-item>
        ...
        <el-table :data="dataList" max-height="600" v-loading="loading">
          ...
          <el-table-column label="商品介绍" align="center" prop="goodsInfo" :show-overflow-tooltip="true" />
             ...
             <el-row>
              <el-col :span="24">
                <el-form-item label="商品简介" prop="goodsInfo">
                  <el-input type="textarea"  rows="4" v-model="formData.goodsInfo" placeholder="请输入商品简介" />
                </el-form-item>
              </el-col>
            </el-row>
...
<script>
import { iosGoodsAdd, iosGoodsUpdate, iosGoodsList,iosGoodsDelete } from "@/api/iosGoods/iosGoods";
export default {
  name: "typesOfPoints",
  components: {
  ...
  methods: {
    getList() {
      this.loading = true;
      iosGoodsList(this.queryParams).then(res => {
      ...
      this.$refs["formData"].validate(valid => {
        if (valid) {
          if (this.formData.id) {//编辑
            iosGoodsUpdate(this.formData).then(res => {
              if (res.code == 200) {
            ...
            iosGoodsAdd(this.formData).then(res => {
              if (res.code == 200) {
