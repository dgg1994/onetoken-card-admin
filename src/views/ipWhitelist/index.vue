      ...
      <div class="conetntBox">
        <div class="flex_sb">
          <el-form :model="queryParams" size="small" :inline="true" label-width="68px">
            ...
            <el-form-item label="" prop="ipSite">
              <el-input v-model="queryParams.ipSite" placeholder="请输入IP地址" clearable />
            </el-form-item>
        ...
        <el-table :data="dataList" max-height="600" v-loading="loading">
          ...
          <el-table-column label="IP地址" align="center" prop="ipSite" />
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="IP地址" prop="ipSite">
                  <el-input v-model="formData.ipSite" placeholder="请输入IP地址" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
...
<script>
import { ipWhitelistList, ipWhitelistAdd, ipWhitelistDelete} from "@/api/sysConfig/sysConfig";
    ...
    submitForm: function () {
      this.$refs["formData"].validate(valid => {
        if (valid) {
          ...
          ipWhitelistAdd(this.formData).then(res => {
              if(res.code == 200){
