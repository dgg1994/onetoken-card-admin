    ...
    <div class="app-container white-bg u-padding-30">
        ...
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
          ...
          <el-form-item label="状态" prop="status">
            <el-select v-model="queryParams.status" placeholder="角色状态" clearable style="width: 240px">
              <el-option v-for="dict in roleStateList" :key="dict.value" :label="dict.label" :value="dict.value" />
            </el-select>
          </el-form-item>
      ...
      <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body :close-on-click-modal="false">
        <el-form ref="form" :model="form" :rules="rules" label-width="100px">
          ...
          <!-- <el-form-item label="下级角色" prop="lowerRoleList">
            <el-select v-model="form.lowerRoleList" placeholder="请选择下级角色" clearable multiple :collapse-tags=true style="width: 100%;">
              <el-option v-for="item in subordinateRoleList" :key="item.roleId" :label="item.roleName" :value="item.roleId">
              </el-option>
            </el-select>
          </el-form-item> -->
          ...
          <el-form-item label="状态">
            <el-radio-group v-model="form.status">
              <el-radio v-for="dict in roleStateList" :key="dict.value" :label="dict.value">{{ dict.label }}</el-radio>
            </el-radio-group>
          </el-form-item>
  ...
  methods: {
    findRoleList() {
      findNormalRole().then((res) => {
        this.subordinateRoleList = res.data;
      });
    },
    /** 查询角色列表 */
    getList() {
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          if (this.form.roleId != undefined) {
            ...
            this.form.updateBy = this.userInfo.username;
