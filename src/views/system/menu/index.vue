    ...
    <div class="app-container white-bg u-padding-30">
      ...
      <el-form :model="queryParams" ref="queryForm"  size="mini" :inline="true" v-show="showSearch">
        ...
        <el-form-item label="状态" prop="status">
          <el-select v-model="queryParams.status" placeholder="菜单状态" clearable>
            <el-option v-for="dict in disableList" :key="dict.value" :label="dict.label" :value="dict.value" />
          </el-select>
        </el-form-item>
        <el-form-item>
      ...
      <el-table v-if="refreshTable" v-loading="loading" :data="menuList" row-key="menuId"
        ...
        <el-table-column prop="status" label="状态" width="80">
          <template slot-scope="scope">
            <dict-tag :options="disableList" :value="scope.row.status" />
          </template>
        </el-table-column>
            ...
            <el-col :span="12" v-if="form.menuType != 'F'">
              <el-form-item prop="visible">
                ...
                <el-radio-group v-model="form.visible">
                  <el-radio v-for="dict in hideList" :key="dict.value" :label="dict.value">{{ dict.label }}</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
            <el-col :span="12" v-if="form.menuType != 'F'">
              <el-form-item prop="status">
                ...
                <el-radio-group v-model="form.status">
                  <el-radio v-for="dict in disableList" :key="dict.value" :label="dict.value">{{ dict.label }}</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
          </el-row>
