        ...
        <div class="flex_sb">
          <el-form :model="queryParams" size="small" :inline="true" label-width="68px">
            ...
            <el-form-item label="" prop="name">
              <el-input v-model="queryParams.name" placeholder="请输入类型名称" clearable style="width: 240px"
            ...
            <el-row>
              ...
              <el-col :span="24">
                <el-form-item label="是否活期" prop="whetherCurrent">
                  <el-select v-model="formData.whetherCurrent" filterable placeholder="是否活期产品" :disabled="upState"
                    style="width: 100%;">
                    <el-option v-for="item in whetherCurrentList" :key="item.id" :label="item.name" :value="item.id">
                    </el-option>
                  </el-select>
...
import { productTypeList, productTypeAdd, productTypeDelete} from "@/api/product/product";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      productTypeList(this.queryParams).then(res => {
