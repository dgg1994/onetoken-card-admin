    ...
    <div class="app-container">
      <div class="conetntBox">
        <div class="flex_end">
          <!-- <el-form :model="queryParams" size="small" :inline="true" label-width="68px">
            ...
            <el-form-item label="" prop="title">
              <el-input v-model="queryParams.title" placeholder="请输入内容" clearable style="width: 240px"
          ...
          <el-row :gutter="10" class="mb8" v-if="dataList.length < 1">
            <el-col :span="1.5">
        ...
        <el-table :data="dataList" max-height="600" v-loading="loading">
          ...
          <el-table-column label="收款人" align="center" prop="payeeMan" />
          <el-table-column label="收款账户" align="center" prop="payeeAccount" />
        ...
        <el-dialog :title="title" :visible.sync="dialogOpen" width="30%" :close-on-click-modal="false" @close="handleClose" append-to-body>
          <el-form ref="formData" :model="formData" :rules="rules" label-width="100px">
            <el-row>
              ...
              <el-col :span="24">
                <el-form-item label="收款人" prop="payeeMan">
                  <el-input v-model="formData.payeeMan" placeholder="请输入收款人" />
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="收款账户" prop="payeeAccount">
                  <el-input v-model="formData.payeeAccount" placeholder="请输入收款账户" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
...
import { firmAccountList, firmAccountAdd, firmAccountDelete,firmAccountUpdate} from "@/api/firmAccount/firmAccount";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      firmAccountList(this.queryParams).then(res => {
      ...
      this.$refs["formData"].validate(valid => {
        if (valid) {
          if(this.formData.id){//编辑
             firmAccountUpdate(this.formData).then(res => {
              if(res.code == 200){
            ...
            firmAccountAdd(this.formData).then(res => {
              if(res.code == 200){
